...
# Project:  nyancoin-qt.pro
# Template: app
# Command: /opt/local/bin/qmake USE_UPNP=- -o Makefile nyancoin-qt.pro
#############################################################################
...
Makefile: nyancoin-qt.pro  /opt/local/share/qt4/mkspecs/macx-g++/qmake.conf /opt/local/share/qt4/mkspecs/common/unix.conf \
	...
	$(QMAKE) USE_UPNP=- -o Makefile nyancoin-qt.pro
...
/Users/eze/nyancoin/build/build.h: FORCE
	cd /Users/eze/nyancoin; /bin/sh share/genbuild.sh /Users/eze/nyancoin/build/build.h
